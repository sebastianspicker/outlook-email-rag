...
Print a lightweight mixed-stack inventory to compare against historical audit
notes or fill another tracked audit artifact.
...
printf '\n## Next step\n\n'
printf '%s\n' '- Copy the relevant lines into your current review document, or compare them against docs/agent/deprecated/AUDIT.md for historical context.'
