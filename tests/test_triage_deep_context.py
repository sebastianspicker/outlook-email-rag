...
class TestEmailDeepContextInputDefaults:
    ...
    def test_all_flags_false(self):
        m = EmailDeepContextInput(
            uid="abc", include_thread=False,
            include_evidence=False, include_sender_stats=False,
        )
...
def _make_result(uid="u1", sender="a@b.com", date="2024-03-15T10:30:00",
                 subject="Hello", score=0.87654, text="Body text here"):
