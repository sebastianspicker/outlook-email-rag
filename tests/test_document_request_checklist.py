...
def test_build_document_request_checklist_groups_requests_and_preservation_actions() -> None:
    payload = build_document_request_checklist(
        matter_evidence_index={
            "top_10_missing_exhibits": [
                ...
                {
                    "requested_exhibit": "NovaTime or attendance records for the disputed period",
            ...
            "rows": [
                {
                    ...
                    "missing_proof": [
                        "Role-matched comparator actors and treatment records are still "
                        "missing from the supplied case scope."
                    ],
                }
            ]
        },
    ...
    assert "novatime_attendance_records" in groups
    attendance_item = groups["novatime_attendance_records"]["items"][0]
