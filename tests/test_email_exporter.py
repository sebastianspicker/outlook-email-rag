...
def test_template_multiple_emails_in_thread():
    emails = [
        _fake_email(uid="e1", subject="Project Update", date="2024-01-01T10:00:00",
                     body_text="Initial update."),
        _fake_email(uid="e2", subject="RE: Project Update", date="2024-01-02T11:00:00",
                     sender_name="Bob", sender_email="bob@example.com",
                     body_text="Thanks for the update."),
        _fake_email(uid="e3", subject="RE: Project Update", date="2024-01-03T09:00:00",
                     body_text="Final reply."),
    ]
    db = _mock_db(thread_emails=emails)
    exporter = EmailExporter(db)
