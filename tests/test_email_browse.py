...
def test_paginated_date_from_filter():
    """list_emails_paginated should filter by date_from (inclusive)."""
    db = EmailDatabase(":memory:")
    db.insert_email(_make_email(message_id="<old@ex.com>", date="2024-01-10T08:00:00"))
    db.insert_email(_make_email(message_id="<new@ex.com>", date="2024-01-20T08:00:00"))
...
def test_paginated_date_to_filter():
    """list_emails_paginated should filter by date_to (inclusive of the full day)."""
    db = EmailDatabase(":memory:")
    db.insert_email(_make_email(message_id="<old@ex.com>", date="2024-01-10T08:00:00"))
    db.insert_email(_make_email(message_id="<new@ex.com>", date="2024-01-20T08:00:00"))
...
def test_paginated_date_range_filter():
    """list_emails_paginated should filter by date range."""
    db = EmailDatabase(":memory:")
    db.insert_email(_make_email(message_id="<e1@ex.com>", date="2024-01-05T08:00:00"))
    db.insert_email(_make_email(message_id="<e2@ex.com>", date="2024-01-15T08:00:00"))
    db.insert_email(_make_email(message_id="<e3@ex.com>", date="2024-01-25T08:00:00"))
