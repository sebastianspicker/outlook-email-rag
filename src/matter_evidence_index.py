...
from .matter_evidence_index_helpers import (
    citation_ids_for_uid as _citation_ids_for_uid,
)
from .matter_evidence_index_helpers import (
...
from .matter_evidence_index_helpers import (
    findings_by_uid as _findings_by_uid,
)
from .matter_evidence_index_helpers import (
...
def build_matter_evidence_index(
    *,
    ...
    findings_by_uid = _findings_by_uid(_as_dict(finding_evidence_index))
    ...
    for index, source in enumerate(
        ...
        findings = findings_by_uid.get(uid, [])
        ...
        rows.append(
            {
                ...
                "supporting_citation_ids": _citation_ids_for_uid(_as_dict(finding_evidence_index), uid),
