...
_POSITIVE_WORDS = {
    ...
    "wonderful", "perfect", "approved", "congratulations", "happy",
    "pleased", "welcome", "agree", "good", "fantastic", "amazing",
    "brilliant", "delighted", "love",
}

_NEGATIVE_WORDS = {
    "unfortunately", "sorry", "problem", "issue", "urgent", "critical",
    "error", "fail", "failed", "failure", "complaint", "disappointed",
    "concerned", "worried", "delay", "rejected", "denied", "wrong",
    "broken", "unable",
}
